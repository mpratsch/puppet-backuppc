...
#
# [*rsync_ssh_remote_user*]
# String. Passes the remote username what is used by the ssh command. Default: backup
#
# [*rsync_ssh_args*]
# Array. Passes the ssh arguments like login user and escape_char. Default: '-e', '$sshPath -l $rsync_ssh_remote_user'
#
# [*rsync_backuppc_path*]
...
class backuppc::server (
  ...
  $rsync_ssh_remote_user      = 'backup',
  $rsync_ssh_args             = [ '-e', "\$sshPath -l $rsync_ssh_remote_user" ],
